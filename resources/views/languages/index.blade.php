    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Data @lang('general.language')</div>

                <div class="panel-body">
                    <div class="table-responsive">
                        <a class="btn btn-success" href="{{ url('language/create') }}"> @lang('general.create')</a>
                        <br>
                        <br>
...
$(document).ready(function(){
    ...
    table = $('#tbl_language').DataTable({ 
        ...
        "order": [],
        "ajax": {
            "url": "{{ url('language/show_language_DT') }}",
            data: {_token:token},
            "type": "POST"
        },
        "columnDefs": [
            ...
            $.ajax({
                ...
                error: function() {
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "{{ url('language/unactivate') }}/"+id,
                                success: function() {
                                    Swal.fire({
