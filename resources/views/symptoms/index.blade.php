    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Data @lang('general.symptom')</div>

                <div class="panel-body">
                    <div class="table-responsive">
                        <a class="btn btn-success" href="{{ url('symptom/create') }}"> @lang('general.create')</a>
                        <br>
                        <br>
                        <table class="table table-bordered" id="tbl_symptom" style="font-size: 12px;">
                        {{ csrf_field() }}
                            <thead>
                                <tr>
...
$(document).ready(function(){
    ...
    table = $('#tbl_symptom').DataTable({ 
        "processing": true,
        "serverSide": true,
        "order": [],
        "ajax": {
            "url": "{{ url('symptom/show_symptom_DT') }}",
            data: {_token:token},
            "type": "POST"
        },
        "columnDefs": [
